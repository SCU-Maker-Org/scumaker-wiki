...
多人合作项目，或者需要长期维护的项目，有必要写好设计文档和 public API 的代码注释。推荐使用 Unified Modeling Language (UML) 来进行建模，绘制 UML 图的方法有很多，可以使用 Visio，也可以用 [`Mermaid.js`](https://mermaid.js.org/) 等文本绘图工具。
